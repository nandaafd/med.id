...
namespace BATCH336A.DataModel
{
    ...
    public partial class TDoctorTreatment
    {
        ...
        [InverseProperty("TDoctorTreatmentCreatedByNavigations")]
        public virtual MUser CreatedByNavigation { get; set; } = null!;
        [ForeignKey("DeletedBy")]
        [InverseProperty("TDoctorTreatmentDeletedByNavigations")]
        public virtual MUser? DeletedByNavigation { get; set; }
        [ForeignKey("ModifiedBy")]
        [InverseProperty("TDoctorTreatmentModifiedByNavigations")]
