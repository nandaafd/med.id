...
namespace BATCH336A.DataModel
{
    ...
    public partial class MLocationLevel
    {
        ...
        [InverseProperty("MLocationLevelCreatedByNavigations")]
        public virtual MUser CreatedByNavigation { get; set; } = null!;
        [ForeignKey("DeletedBy")]
        [InverseProperty("MLocationLevelDeletedByNavigations")]
        public virtual MUser? DeletedByNavigation { get; set; }
        [ForeignKey("ModifiedBy")]
        [InverseProperty("MLocationLevelModifiedByNavigations")]
