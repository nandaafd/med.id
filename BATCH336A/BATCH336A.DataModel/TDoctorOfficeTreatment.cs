...
namespace BATCH336A.DataModel
{
    ...
    public partial class TDoctorOfficeTreatment
    {
        ...
        [InverseProperty("TDoctorOfficeTreatmentCreatedByNavigations")]
        public virtual MUser CreatedByNavigation { get; set; } = null!;
        [ForeignKey("DeletedBy")]
        [InverseProperty("TDoctorOfficeTreatmentDeletedByNavigations")]
        public virtual MUser? DeletedByNavigation { get; set; }
        [ForeignKey("ModifiedBy")]
        [InverseProperty("TDoctorOfficeTreatmentModifiedByNavigations")]
